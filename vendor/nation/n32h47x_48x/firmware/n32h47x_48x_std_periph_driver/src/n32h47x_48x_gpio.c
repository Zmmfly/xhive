...
/**
 *\*\name   AFIO_ConfigPinAnalogSignalChannel.
 *\*\fun    Enable or disable the analog signal channel for GPIOx pin.
 *\*\param   GPIOx :
 *\*\          - GPIOA
 *\*\          - GPIOB
 *\*\          - GPIOC
 ...
 *\*\return none
 */
void AFIO_ConfigPinAnalogSignalChannel(GPIO_Module* GPIOx, uint32_t Pin,FunctionalState cmd)
{
    uint32_t tempReg;
    uint32_t RegNum;
    uint32_t BitMask;
