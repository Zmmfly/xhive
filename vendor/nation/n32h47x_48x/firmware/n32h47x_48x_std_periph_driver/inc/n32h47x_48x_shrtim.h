...
#define SHRTIM_EXEV2SRC_ATIM2_TRGO   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 2 */
#define SHRTIM_EXEV3SRC_ATIM3_TRGO   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 3 */
#define SHRTIM_EXEV4SRC_RESERVED   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 4 */
#define SHRTIM_EXEV5SRC_RESERVED   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 5 */
#define SHRTIM_EXEV6SRC_RESERVED   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 6 */
#define SHRTIM_EXEV7SRC_BTIM2_TRGO   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 7 */
#define SHRTIM_EXEV8SRC_RESERVED   (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 8 */
#define SHRTIM_EXEV9SRC_GTIM8_TRGO  (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 9 */
#define SHRTIM_EXEV10SRC_GTIM9_TRGO  (SHRTIM_EXEVCTRL1_EXEV1SRC_1)                        /* External event source 3 for External Event 10 */
...
#define SHRTIM_EXEV7SRC_ADC3_AWD2   (SHRTIM_EXEVCTRL1_EXEV1SRC_1 | SHRTIM_EXEVCTRL1_EXEV1SRC_0) /* External event source 4 for External Event 7 */
#define SHRTIM_EXEV8SRC_ADC3_AWD3   (SHRTIM_EXEVCTRL1_EXEV1SRC_1 | SHRTIM_EXEVCTRL1_EXEV1SRC_0) /* External event source 4 for External Event 8 */
#define SHRTIM_EXEV9SRC_ADC4_AWD2   (SHRTIM_EXEVCTRL1_EXEV1SRC_1 | SHRTIM_EXEVCTRL1_EXEV1SRC_0) /* External event source 4 for External Event 9 */
#define SHRTIM_EXEV10SRC_ADC4_AWD3  (SHRTIM_EXEVCTRL1_EXEV1SRC_1 | SHRTIM_EXEVCTRL1_EXEV1SRC_0) /* External event source 4 for External Event 10 */
